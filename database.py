        ...
        service_cats = [
            {
                ...
                'full_description': 'Solar Pre-Design, also known as Solar Preliminary Design, is the essential first phase in planning and bidding for solar projects. It involves creating initial layout drawings and photorealistic 3D visualization models using industry-leading software. This process integrates GIS data, Google Earth imagery, and site measurements to develop highly accurate solar proposals.\n\nThese pre-sales designs help clients visualize their solar installation with clear insights into row spacing, shadow analysis, and expected energy production. Delivering compelling, EPC-grade pre-sales layouts significantly accelerates client approvals and maximizes proposal conversion rates.',
                'icon': 'presentation',
                'hero_heading': 'Solar 3D Pre-Design',
                'hero_subtitle': 'Accurate 3D solar layouts with shading analysis, PVsyst reports, and ROI projections for EPC companies worldwide.',
            ...
            },
            {
                ...
                'full_description': '3D Post-Sales Design is the engineering phase where approved solar proposals are converted into execution-ready, millimeter-accurate 3D installation models. It models actual structural beams, module clamps, inverter placements, cable trays, and walkway corridors in complete detail.\n\nThese high-precision 3D digital twins serve as a single source of truth for site engineers, structural contractors, and project developers. By identifying spatial clashes and structural clearances beforehand, post-sales 3D modeling prevents expensive on-site rework and guarantees smooth construction execution.',
                'icon': 'box',
            ...
            },
            {
                ...
                'full_description': 'Comprehensive Solar Engineering Consultancy provides end-to-end technical advisory, Detailed Project Reports (DPR), and engineering documentation for commercial, industrial, and utility-scale solar power plants. It encompasses yield simulations (P50/P90), equipment selection, and civil-electrical design compliance.\n\nOur certified solar engineers optimize system topography to maximize generation yield while minimizing lifecycle balance of system (BOS) costs. From site feasibility studies to final permitting documentation, our consultancy ensures strict adherence to IEC, NEC, and local grid standards.',
                'icon': 'compass',
            ...
            },
            {
                ...
                'full_description': 'CEIG Drawing Services involve the preparation of statutory electrical inspection drawings required for Chief Electrical Inspector to the Government (CEIG) regulatory clearance. This documentation is mandatory for charging, commissioning, and grid synchronization of solar installations.\n\nEarthX prepares error-free Single Line Diagrams (SLD), earthing grid calculation layouts, lightning protection radius drawings (IS/IEC 62305), and equipment layout schematics. Our thorough compliance check-lists help EPC contractors clear electrical inspector audits on the very first submission.',
                'icon': 'file-check',
            ...
            },
            {
                ...
                'full_description': 'Ground Mounted Solar Design delivers full-scale civil, structural, and electrical engineering packages for multi-megawatt solar farms. The scope includes Digital Elevation Modeling (DEM), cut-and-fill optimization, hydrology storm-water runoff drainage, and pile foundation depth analysis.\n\nWe optimize module tilt angles, inter-row pitch, and tracker configurations to eliminate inter-row shading and structural wind loads. Our comprehensive drawing sets include grading plans, road networks, boundary fencing, piling coordinates, and DC/AC cabling layouts.',
                'icon': 'mountain',
            ...
            },
            {
                ...
                'full_description': 'Solar Electrical Calculation Services provide rigorous sizing and safety verification for all DC and AC electrical equipment in a photovoltaic plant. This includes string sizing, DC voltage drop optimization (<1.5%), AC cable ampacity derating, transformer sizing, and short-circuit fault level analysis.\n\nWe generate comprehensive earthing grid resistance calculations according to IEEE 80 standards, complete lightning protection studies, and exhaustive Bill of Quantities (BOQ) schedules. These calculations protect critical plant assets and guarantee safe, reliable operation throughout the project lifecycle.',
                'icon': 'calculator',
            ...
            },
            {
                ...
                'full_description': 'Substation and Grid Evacuation Design encompasses complete engineering for solar plant pooling substations ranging from 33kV to 220kV/400kV. It covers switchyard layouts, power transformers, circuit breaker bays, busbar sizing, and gantry structural engineering.\n\nOur high-voltage transmission engineers deliver transmission line tower routing, clearance profiling, SCADA/telemetry communication schematics, and relay protection coordinate diagrams. We ensure full compliance with transmission utility interconnect guidelines for smooth grid synchronization.',
                'icon': 'radio',
            ...
            },
            {
                ...
                'full_description': 'Shadow Analysis and Structural Stability Reports combine precise astronomical shade modeling with structural wind-load finite element analysis. Using 3D sun-path simulations across all 365 days, we identify exact solar irradiance losses caused by parapets, nearby buildings, vegetation, and inter-row modules.\n\nCoupled with STAAD.Pro structural stability calculations, we evaluate dead loads, live loads, and extreme wind load pressures in accordance with ASCE 7-16 and IS 875 (Part 3). The resulting engineering reports prove structural safety to lenders and optimize solar module positioning for maximum kilowatt-hour generation.',
                'icon': 'sun',
